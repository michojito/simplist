...
export function MiniGhostButton (props: Props) {
    ...
    return (
        ...
        >
            { props.leadingIcon !== undefined && (
                <Icon name='Leading Icon' svg={props.leadingIcon} size='small'
            ...
            { props.trailingIcon !== undefined && (
                <Icon name='Leading Icon' svg={props.trailingIcon} size='small'
                    fill={props.textColor || props.color?.text.accent || '#fff'}
                />
            )}
        </AutoLayout>
